...
public class ObjParserTests
{
    ...
    public void Triangle_position_x_is_negated_and_indices_are_zero_based()
    {
        ...
        Assert.Equal(new System.Collections.Generic.List<int> { 2, 1, 0 }, sm.Triangles);
    }
    ...
    public void Quad_face_is_fan_triangulated_with_reversed_winding()
    {
        ...
        Assert.Equal(new System.Collections.Generic.List<int> { 2, 1, 0, 3, 2, 0 }, sm.Triangles);
    }
    ...
    public void Multiple_usemtl_groups_create_separate_submeshes()
    {
        ...
        Assert.Equal(new System.Collections.Generic.List<int> { 2, 1, 0 }, data.Submeshes[0].Triangles);

        Assert.Equal("MatB", data.Submeshes[1].Material);
        Assert.Equal(new System.Collections.Generic.List<int> { 1, 2, 0 }, data.Submeshes[1].Triangles);
    }
